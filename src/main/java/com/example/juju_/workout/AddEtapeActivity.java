    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            ...
            for(int i=0;i<workout.getNbEtape();i++){
                array_etape_tmp.add("Nouvel Exercice");
            }
            ...
            lstview.setOnItemClickListener(new ListView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                    ...
                    startActivityForResult(new Intent(AddEtapeActivity.this,EditEtapeActivity.class),1);
    ...
    protected void onActivityResult(int requestCode, int resultCode,Intent intent) {
        ...
        if (resultCode == 1) {
            ...
            if (intent != null) {
                ...
                System.out.println(temps_etape_tmp+"//"+pause_etape_tmp);
                ...
                if (!workout.getList_etape().contains(etap_tmp)) {
                    workout.getList_etape().add(etap_tmp);
                }
